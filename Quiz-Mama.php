...
<html>
    <head>
        <title>Quiz über Nathalie</title>
    ...
    <body class="body-mama">
        ...
        <div class="container">
            ...
            <h1>Ein Quiz über meine Mama</h1>
            ...
            <div class="row quiz-options">
                <div class="col-md-3">
                    ...
                    <form action="" method="post">
                        ...
                        <?php
                        $questions = array ( "Welches Haustiere hat sie?" => array ("Katze&Hamster", "Hund&Vogel", "Hund&Katze", "Hund&Fische"),

                            "Wie alt ist sie?" => array ("43", "44", "39", "40"),

                            "Wann hat sie Geburtstag?" => array ("9. Mai 1974", "10. September 1972", "30. November 1975", "8. Dezember 1973"),

                            "In welche Schule ging sie?" => array ("Sacre Coeur", "Kenyongasse", "Piaristengasse", "Spengergasse"),

                            "Wie heißen ihre Eltern" => array ("Walter&Vera", "Karl&Monika", "Thomas&Anna", "Bernhard&Vera"),

                            "Welches Handy hat sie?" => array ("iPhone 6+", "iPhone SE", "iPhone 7+", "iPhone 5"),

                            "Wie heißt ihr Hund?" => array ("Afro", "Boss", "Timo", "Moritz"),

                            "Wie viele Geschwister hat sie?" => array ("2", "1", "3", "Keine"),

                            "Welche Haarfarbe hat sie?" => array ("Blond", "Braun", "Schwarz", "Orange"),

                            "Wie heißt ihre Katze?" => array ("Timi", "Tiger", "Fluffy", "Leo"),
            ...
            <div class="row quiz-options">
                ...
                if ($answer1 == "Hund&Katze") { $totalCorrect++; }
                if ($answer2 == "43") { $totalCorrect++; }
                if ($answer3 == "8. Dezember 1973") { $totalCorrect++; }
                if ($answer4 == "Kenyongasse") { $totalCorrect++; }
                if ($answer5 == "Walter&Vera") { $totalCorrect++; }
                if ($answer6 == "iPhone 7+") { $totalCorrect++; }
                if ($answer7 == "Timo") { $totalCorrect++; }
                if ($answer8 == "1") { $totalCorrect++; }
                if ($answer9 == "Blond") { $totalCorrect++; }
                if ($answer10 == "Leo") { $totalCorrect++; }
